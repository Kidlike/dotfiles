...
hi StatusLine cterm=reverse gui=reverse ctermfg=14 ctermbg=8 guifg=#93a1a1 guibg=NONE
hi StatusLineNC cterm=reverse gui=reverse ctermfg=11 ctermbg=0 guifg=#657b83 guibg=NONE
hi User1 ctermfg=14 ctermbg=0 guifg=#93a1a1 guibg=NONE
